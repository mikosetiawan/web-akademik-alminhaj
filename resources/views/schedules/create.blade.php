<x-app-layout title="Tambah Jadwal">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('schedules.store') }}" method="POST">
                    ...
                    <div class="mt-1">
                        <div class="relative">
                            <button type="button" id="students-toggle"
                                ...
                                <span id="students-selected" class="block truncate text-sm text-gray-700">Pilih
                                    siswa</span>
                                <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                    <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                ...
                <div class="flex space-x-4">
                    <button type="submit"
                        class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 text-sm">Tambah
                        Jadwal</button>
                    <a href="{{ route('schedules.index') }}"
                        class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 text-sm">Batal</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('class_id').क्ष
