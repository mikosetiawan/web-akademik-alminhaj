<x-app-layout title="Daftar Kelas">
    <div class="container mx-auto px-4 py-8">
        ...
        <a href="{{ route('classes.create') }}"
            class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 mb-6">Tambah Kelas Baru</a>
                ...
                <table id="classesTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($classes as $class)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">{{ $class->code }}</td>
